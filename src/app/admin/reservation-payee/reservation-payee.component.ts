...
@Component({
  selector: 'app-reservation-payee',
  templateUrl: './reservation-payee.component.html',
  styleUrls: ['./reservation-payee.component.scss']
})
export class ReservationPayeeComponent {
  countries: any[] = [];
  users: any[] = [];
  userNames: String[] = [];
  emails: String[] = [];
  ...
  ngOnInit(): void {
    ...
    this.users = [
      ...
      { image: 'assets/images/profile/user-1.jpg', email: 'kradaniel@gmail.com', name: 'KRA Daniel', tel: '+225 0929829283', role: 'BANQUE', statut: 2 },
